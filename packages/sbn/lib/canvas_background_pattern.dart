enum CanvasBackgroundPattern {
  ...
  /// Isometric grid: vertical lines + lines at 30° and 150° forming
  /// equilateral triangles for isometric engineering drawings.
  isometric('isometric', requiresClipping: true),

  /// Engineering grid (mm-style): light lines every [lineHeight] pixels
  /// with heavy lines every 10×[lineHeight] pixels.
  engineeringGrid('engineeringGrid', requiresClipping: true);
